...
completed: true
due:
source: 基于《雅思口语Part3实用表达库.md》精简版
---
...
**替换**: It really depends on the context | I think it varies quite a bit depending on...
...
**话题**: 社交媒体、科技、社会现象
**替换**: I understand that point, but I tend to think... | I get what you mean, but personally I believe...
...
**话题**: 科技依赖、社会变化、个人观点演进
**替换**: I used to think [X], but now I'm beginning to see that... | The more I think about it, the more I feel that...
...
**话题**: 科技影响、工作变化、教育改革
**替换**: A good case in point is... | Let me give you an example from my own experience...
...
**话题**: 社会现象、青年创业、行为改变
**替换**: There are a few factors, but the biggest one is probably... | Multiple factors contribute, but the primary driver is...
...
**替换**: But then again... / But at the same time... | Conversely, one must also consider...
...
**话题**: 幸福、成功、生活质量、深度思考
**替换**: I've actually given this some thought, and my feeling is... | It's something I've been thinking about quite a bit...
...
**话题**: 教育未来、科技趋势、社会变化
**替换**: From what I can see, it seems like... | There's a pattern I'm noticing where...
...
**替换**: The real disconnect is that... | What's interesting is the difference between... | The tension between... is where...
...
**话题**: 通用（任何需要思考时间的问题）
**替换**: Hmm, I haven't really thought about that before, but... | That's actually something I've been thinking about lately...
...
**话题**: 专业术语、模糊问题（确保理解）
**替换**: So you're asking about... right? | Could you clarify whether you are referring to...?
...
**话题**: 未来预测、复杂问题、不确定事项
**替换**: I'm not entirely sure, but... | While there are uncertainties, I believe that...
...
- climbing the corporate ladder (职场晋升)
...
| 问题类型 | 推荐句型 | 示例问题 |
|---------|---------|---------|
| **Do you think...?** | #1, #2, #3 | Do you think online education is effective? |
| **Why do you think...?** | #5, #9 | Why do young people want to start businesses? |
| **How has... changed?** | #4, #8 | How has technology changed work? |
| **Which is better...?** | #6, #1 | Big city or small town? |
| **What will... in the future?** | #8, #12 | How will education change? |
| **复杂/专业问题** | #10, #11 | Emotional intelligence in workplace? |
| **不确定的问题** | #12, #10 | AI's impact on employment? |
...
示例:
> It depends a lot on the type of subject. For programming, online works great. But on the other hand, literature needs classroom discussion.
...
示例:
> That's an interesting question—let me think. Partly it's because of social media. But the main reason is young people want flexibility. From what I can see, this trend will continue.
...
| Band | 句型掌握 | 回答长度 | 思维深度 |
|------|---------|---------|---------|
| **6.0-6.5** | 至少6个句型 | 2-3句 | 偶尔展示辩证思维 |
| **7.0-7.5** | 至少9个句型 | 3-5句 | 经常展示复杂思维 |
| **8.0+** | 12个句型灵活运用 | 5+句 | 深度分析，抽象思维 |
...
- [ ] 我能说出至少8个句型的核心表达
- [ ] 我知道每个句型适用于什么类型的问题
- [ ] 我有3-4个准备好的个人例子（用于#4举例说明型）
- [ ] 我知道如何争取思考时间而不说"uh..."
- [ ] 我知道如何展示不确定性的正确方式

---

**完整详细版本**: 《雅思口语Part3实用表达库.md》
**备考建议**: 详见完整指南的"4周提升计划"
