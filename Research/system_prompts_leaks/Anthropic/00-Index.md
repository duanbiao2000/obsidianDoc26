...
|:-----|:---------|:-----|:-------|:----:|:-----------:|
| [[vocabulary-index]] | **词汇总索引** | 词汇体系概览，学习路径导航 | ⭐⭐ | Intermediate |
| [[01-Degree-Modifiers]] | **程度修饰语** | appropriately, strategically, carefully... | ⭐⭐⭐ | Advanced |
| [[02-Tone-Controllers]] | **语气控制词** | MUST, NEVER, strongly, should... | ⭐⭐⭐ | Advanced |
| [[03-Boundary-Words]] | **边界词** | unless, only, maximum, approximately... | ⭐⭐ | Intermediate |
| [[04-Nuanced-Expressions]] | **微妙表达** | naturally, politely, breaks continuity... | ⭐⭐⭐⭐ | Expert |
| [[05-Action-Guides]] | **操作指导词** | Extract, Avoid, Prioritize, Synthesize... | ⭐⭐⭐ | Advanced |
| [[vocabulary-extraction-guide]] | **提取指南** | 手动提取方法，识别规则 | ⭐⭐⭐⭐ | Expert |
| [[Cross-Document-Comparisons]] | **跨文档对比** | 公司/版本风格对比分析 | ⭐⭐⭐⭐ | Expert |
| [[Vocabulary-Exercises]] | **综合练习** | 80+ 练习题目，闪卡+场景应用 | ⭐⭐⭐ | Advanced |

### 阶段 1：核心机制理解 | Stage 1: Core Mechanisms

| 文档 | Document | 重点 | Focus | 难度 | Difficulty |
|------|----------|------|-------|------|------------|
| [[thinking-mode]] | **思维模式** | Chain of Thought, 推理透明化 | ⭐⭐⭐ | Advanced |
| [[past-chats-tools]] | **对话检索** | conversation_search, recent_chats | ⭐⭐ | Intermediate |
| [[search-behavior]] | **搜索行为** | web_search 决策树, 版权边界 | ⭐⭐⭐⭐ | Expert |
