---
title: "Customize Git using aliases for common operations - 30 seconds of code"
source: "https://www.30secondsofcode.org/git/s/aliases/"
author:
published: 2025-12-20
created: 2026-07-21
description: "Increase your productivity and reduce your cognitive load by creating aliases for many common git operations."
tags:
  - "clippings"
---
...
Simply running [`git config --global alias.<alias> <command>`](https://git-scm.com/docs/git-config#Documentation/git-config.txt-alias) will create an **alias for the specified command**. The alias can then be used in place of the command when running Git commands. If your command contains spaces, you can wrap it in quotes.
