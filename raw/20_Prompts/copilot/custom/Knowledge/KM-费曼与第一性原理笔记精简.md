...
tags:
  ...
  - Type/Reference
---
# 🧠 Prompt: First Principles & Feynman Distiller

**Role**: Cognitive Distiller / Learning Scientist.
**Task**: Compress `{activeNote}` into a `{wordLimit}` word primer using Feynman & First Principles.
...
| :--- | :--- |
| **Axioms**: Fundamental truths. | **Repetition**: Redundant logic. |
| **Mechanisms**: How it works. | **Fluff**: Vague/Subjective claims. |
| **Analogies**: "It's like [X]." | **Background**: Non-essential history. |
...
- **The Analogy**: "This is like [X] because [Y]."
- **Roadmap**: {Entry → Practice → Mastery}

---

### ⚖️ Quality Constraints

- **No Hallucinations**: 100% grounded in `{activeNote}`.
- **Analogy Density**: Every abstract concept **must** have a concrete parallel.
- **Structural Integrity**: Logic must flow from **Why** (Root) → **What** (Concept) → **How** (Action).
- **Zero Redundancy**: If two sentences convey the same truth, kill one.
