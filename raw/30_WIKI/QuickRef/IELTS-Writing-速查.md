...
| Agree/Disagree | 立场 → 理由1 → 理由2 → 让步 → 结论 |

| Discuss Both Views | 引入 → 观点A → 观点B → 自己立场 → 结论 |

| Advantages/Disadvantages | 引入 → 优势 → 劣势 → 立场 → 结论 |
...
- While it is true that..., this argument overlooks...
