...
| ---------------------------------------------- | ------------------------- |
| [General](general.md)       | Universal principles      |
| [TypeScript](typescript.md) | TypeScript conventions    |
| [JavaScript](javascript.md) | JavaScript best practices |
| [Python](python.md)         | Python standards          |
| [Go](go.md)                 | Go idioms                 |
| [C#](csharp.md)             | C# conventions            |
| [Dart](dart.md)             | Dart/Flutter patterns     |
| [HTML/CSS](html-css.md)     | Web standards             |
