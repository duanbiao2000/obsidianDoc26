...
completed: true
due:
source: 基于《雅思写作Task2高级句型库.md》精简版
---
...
**话题**: 教育/科技/环境通用
**替换**: The moment arrives when... | Nothing matters until...
...
**话题**: 观点题、讨论题通用
**替换**: While..., [Main Argument] | Although..., [Main Argument]
...
**话题**: 数据论证、趋势分析
**替换**: [Trend] is increasingly apparent | Accumulating evidence suggests...
...
**话题**: 教育/科技/环境/社会通用
**替换**: consists not in... | Far from being... | lies not in...
...
**话题**: 教育改革、政策分析
**替换**: The true source of... | The foundation of... | Real... does not live in...
...
**话题**: 教育/能力/价值判断
**替换**: The essence of... | ...is to be found in...
...
**话题**: 政策评估、价值判断
**替换**: Only those... | What characterizes... is not...
...
**话题**: 科技影响、教育问题
**替换**: ...is analogous to... | Just as..., so too does...
...
**话题**: 政策建议、教育改革
**替换**: The objective should be establishing... | What should be prioritized is...
...
**话题**: 行为解释、社会现象
**替换**: Rather than... represents... functioning as designed
...
**话题**: 沟通、政策、教育
**替换**: The tension between... | The disconnect separating... | At the intersection of...
...
**话题**: 比较、定义、评价
**替换**: The distinction between... lies in... | What distinguishes... is...
...
**话题**: 个人发展、社会变革
**替换**: requires not passive reception but active construction | is not a destination but a journey
...
**话题**: 语言、教育、文化
**替换**: serves not only as... but also as... | Beyond its... constitutes...
...
| Band | 推荐句型 | 使用频率 |
|------|---------|---------|
| 6.0-6.5 | #3, #9, #10 | 每篇2-3个 |
| 7.0-7.5 | #1, #2, #4, #5, #6, #13 | 每篇3-4个 |
| 8.0+ | #7, #8, #11, #12, #14, #15 | 自然融合 |
...
**详细说明**: 请参阅《雅思写作Task2句型详解.md》
**实战应用**: 请参阅《雅思写作Task2实战手册.md》
