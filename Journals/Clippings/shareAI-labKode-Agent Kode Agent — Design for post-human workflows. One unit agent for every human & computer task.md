---
title: "shareAI-lab/Kode-Agent: Kode Agent — Design for post-human workflows. One unit agent for every human & computer task."
source: "https://github.com/shareAI-lab/Kode-Agent/blob/main/README.zh-CN.md"
author:
  - "[[GitHub]]"
published:
created: 2026-03-20
description: "Kode Agent — Design for post-human workflows. One unit agent for every human & computer task. - shareAI-lab/Kode-Agent"
tags:
  - "clippings"
---
## Kode - 终端 AI 助手

[English](https://github.com/shareAI-lab/Kode-Agent/blob/main/README.md) | [贡献指南](https://github.com/shareAI-lab/Kode-Agent/blob/main/CONTRIBUTING.md) | [文档](https://github.com/shareAI-lab/Kode-Agent/blob/main/docs)
...
- 推荐使用 VS Code 集成终端以获得最佳体验：
	- 字体与图标显示更稳定，UI 体验更好。
		- 相比传统命令提示符，路径和编码问题更少。
- 可选：安装 Git for Windows 以获得增强的类 Unix 功能： [https://git-scm.com/download/win](https://git-scm.com/download/win)
...
我们欢迎贡献！请查看我们的 [贡献指南](https://github.com/shareAI-lab/Kode-Agent/blob/main/CONTRIBUTING.md) 了解详情。

## 许可证

Apache 2.0 许可证 - 详见 [LICENSE](https://github.com/shareAI-lab/Kode-Agent/blob/main/LICENSE) 。