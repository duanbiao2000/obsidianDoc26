---
name: "source-command-annotate-doc-framework"
description: "Annotate documentation framework learning materials with bilingual insights and heuristic questions"
---

# source-command-annotate-doc-framework

Use this skill when the user asks to run the migrated source command `annotate-doc-framework`.
